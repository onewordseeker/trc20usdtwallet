...
<head>
    ...
    <title>SPK Admin panel - Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('swap-history') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Buy SPK Transactions</span></a>
            </li>
            <!-- Divider -->
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('add-news') }}">
                    <i class="fas fa-fw fa-table"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">SPK Admin</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SPK App {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
