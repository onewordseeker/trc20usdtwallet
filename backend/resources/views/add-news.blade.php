@extends('layouts.app')
    @section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">SPK Add News</h1>
                    <p class="mb-4">Add news article by filling all the information below.</p>
                        ...
                        <div class="card-body">
                          ...
                          <div class="offset-md-3 col-md-6">
                              ...
                              <div class="mb-2">
                                ...
                                <div>
                                	<input name="title" required id="title" type="text" :value="old('title')" class="form-control form-control-user" placeholder="Enter News Title">
                            	</div>
                              </div>
                               <div class="mb-2">
                                <label style="padding: 5px; margin-bottom: 0px;">Author Name</label>
                                <div>
                                	<input name="author" required id="author" type="text" :value="old('author')" class="form-control form-control-user" placeholder="Enter Author Name">
                            	</div>
                              </div>
                                 <div class="mb-2">
                                <label style="padding: 5px; margin-bottom: 0px;">News Content</label>
                                <div>
                                	<textarea name="description" required id="description" :value="old('description')" class="form-control form-control-user" placeholder="Enter News Content"></textarea>
                            	</div>
                              </div>
                               <div class="mb-2">
                                <label style="padding: 5px; margin-bottom: 0px;">News Image URL</label>
                                <div>
                                	<input name="image" required id="image" type="file" class="form-control form-control-user" placeholder="Select News Image">
                            	</div>
                              </div>
                              </div>
