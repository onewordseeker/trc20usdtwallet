                    ...
                    <div class="card-body">
                        ...
                        <form class="user">
                            ...
                            <div class="form-group">
                                <input type="text"  id="to_address" required name="to_address" onChange="setValue(this,'hiddenToAddress')" :value="old('to_address')" class="form-control form-control-user" placeholder="Enter receiver ({{ $wallet->chain == 'ethereum' ? 'BSC' : $wallet->chain }}) address">
                            </div>
                            <div class="form-group">
