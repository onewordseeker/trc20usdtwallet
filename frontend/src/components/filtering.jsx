    ...
    <MainCard content={false}>
      ...
      <ScrollX>
        <TableContainer component={Paper}>
          ...
          {/* <Pagination onChange={handleChangePagination} count={10} defaultPage={1} variant="contained" color="primary" shape="circular" sx={{ padding: 2, float: 'right' }} /> */}
        </TableContainer>
      </ScrollX>
    </MainCard>
  );
...
export default function FilteringTable({ data }) {
  useEffect(() => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: (props) => {
          return (
            <IconButton aria-label="expand row" size="small" onClick={() => window.open(props.getValue(), '_blank')}>
              <Global />
            </IconButton>
          );
        }
