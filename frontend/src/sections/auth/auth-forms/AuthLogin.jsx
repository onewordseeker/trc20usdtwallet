    ...
    <>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          email: Yup.string().email('Must be a valid email').max(255).required('Username/Email is required'),
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            if (flag) {
              navigate('/code-verification', { state: { email: values.email, password: values.password } });
            }
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  ...
                  <OutlinedInput
                    ...
                    placeholder="eg: kabboliate@gmail.com"
                    fullWidth
