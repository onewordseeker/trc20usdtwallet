...
// Wallets management
const Wallets = Loadable(lazy(() => import('pages/Wallets')));
// Admin wallet management
const AdminWallet = Loadable(lazy(() => import('pages/AdminWallet')));

// transactions
const Transactions = Loadable(lazy(() => import('pages/Transactions')));

// Activity Logs
const ActivityLogs = Loadable(lazy(() => import('pages/ActivityLogs')));
...
const UserTab2Fa = Loadable(lazy(() => import('sections/apps/profiles/user/Tab2fa')));
